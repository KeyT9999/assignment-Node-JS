...
## Áp dụng cho dạng đề: Equipment Rental Management System (`05_EquipmentRental`)

Tài liệu này hướng dẫn cách đổi nhanh tên dự án, tên các tệp, các biến và đường dẫn từ dự án mẫu `05_EquipmentRental` sang đề thi cụ thể ngày mai bằng tính năng **Global Find & Replace (Ctrl + Shift + H)** của VS Code.
...
1. Đổi tên thư mục gốc `05_EquipmentRental` thành:
...
| :--- | :--- | :--- |
| `/models` | `equipmentModel.js` | `<newResourceName>Model.js` |
| | `rentalModel.js` | `<newBookingName>Model.js` |
| `/controllers` | `equipmentController.js` | `<newResourceName>Controller.js` |
| | `rentalController.js` | `<newBookingName>Controller.js` |
| `/routes` | `equipmentRoutes.js` | `<newResourceName>Routes.js` |
| | `rentalRoutes.js` | `<newBookingName>Routes.js` |
...
*(Ví dụ: `const Equipment = require(...)` sẽ tự động đổi thành `const Space = require(...)`)*
