...
## Áp dụng cho dạng đề: Smart EV Charging Station Management System (`08_EVChargingSystem`)

Tài liệu này hướng dẫn cách đổi nhanh tên dự án, tên các tệp, các biến và đường dẫn từ dự án mẫu `08_EVChargingSystem` sang đề thi cụ thể ngày mai bằng tính năng **Global Find & Replace (Ctrl + Shift + H)** của VS Code.
...
1. Đổi tên thư mục gốc `08_EVChargingSystem` thành:
...
| :--- | :--- | :--- |
| `/models` | `stationModel.js` | `<newResourceName>Model.js` |
| | `sessionModel.js` | `<newBookingName>Model.js` |
| `/controllers` | `stationController.js` | `<newResourceName>Controller.js` |
| | `sessionController.js` | `<newBookingName>Controller.js` |
| `/routes` | `stationRoutes.js` | `<newResourceName>Routes.js` |
| | `sessionRoutes.js` | `<newBookingName>Routes.js` |
