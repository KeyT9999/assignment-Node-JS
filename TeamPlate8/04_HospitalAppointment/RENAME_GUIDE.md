...
## Áp dụng cho dạng đề: Hospital Appointment Management System (`04_HospitalAppointment`)

Tài liệu này hướng dẫn cách đổi nhanh tên dự án, tên các tệp, các biến và đường dẫn từ dự án mẫu `04_HospitalAppointment` sang đề thi cụ thể ngày mai bằng tính năng **Global Find & Replace (Ctrl + Shift + H)** của VS Code.
...
1. Đổi tên thư mục gốc `04_HospitalAppointment` thành:
...
| :--- | :--- | :--- |
| `/models` | `doctorModel.js` | `<newResourceName>Model.js` |
| | `appointmentModel.js` | `<newBookingName>Model.js` |
| `/controllers` | `doctorController.js` | `<newResourceName>Controller.js` |
| | `appointmentController.js` | `<newBookingName>Controller.js` |
| `/routes` | `doctorRoutes.js` | `<newResourceName>Routes.js` |
| | `appointmentRoutes.js` | `<newBookingName>Routes.js` |
