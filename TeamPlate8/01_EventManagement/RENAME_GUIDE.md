...
## Áp dụng cho dạng đề: Event Management System (`01_EventManagement`)

Tài liệu này hướng dẫn cách đổi nhanh tên dự án, tên các tệp, các biến và đường dẫn từ dự án mẫu `01_EventManagement` sang đề thi cụ thể ngày mai bằng tính năng **Global Find & Replace (Ctrl + Shift + H)** của VS Code.
...
1. Đổi tên thư mục gốc `01_EventManagement` thành:
...
| :--- | :--- | :--- |
| `/models` | `eventModel.js` | `<newResourceName>Model.js` |
| | `registrationModel.js` | `<newBookingName>Model.js` |
| `/controllers` | `eventController.js` | `<newResourceName>Controller.js` |
| | `registrationController.js` | `<newBookingName>Controller.js` |
| `/routes` | `eventRoutes.js` | `<newResourceName>Routes.js` |
| | `registrationRoutes.js` | `<newBookingName>Routes.js` |
...
* **Tìm kiếm**: `Registration` $ightarrow$ **Thay thế**: `<TênModelBookingMới>`
*(Ví dụ: `const Event = require(...)` sẽ tự động đổi thành `const Space = require(...)`)*
