# Hướng dẫn kiểm thử Postman — TranKimThang_EVChargingSystem

Guide này được sinh đồng bộ từ `TranKimThang_EVChargingSystem.postman_collection.json`. Có **9 test cases**; mỗi test ghi rõ request và kết quả tối thiểu cần kiểm tra.
...
Import `TranKimThang_EVChargingSystem.postman_collection.json` vào Postman. Chạy request theo đúng thứ tự bên dưới vì các script có thể lưu token hoặc ID cho bước sau.
...
1. Mở Postman → Import → chọn file `TranKimThang_EVChargingSystem.postman_collection.json`
